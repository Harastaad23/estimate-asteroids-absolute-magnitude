...
if __name__ == "__main__":
    ...
    # Path for both lightcurve and ephemeris
    path_data = [
                "19 Fortuna/Fortuna_data_new.csv", "87 Sylvia/Sylvia_data.csv",
                "2579 Spartacus/Spartacus_data.csv", "58 Concordia/Concordia_data.csv",
                "111 Ate/Ate_data.csv", "353 Ruperto/Ruperto_data_no_13_14.csv",
                "397 Vienna/Vienna_data.csv", "477 Italia/Italia_data.csv"
                ]
    path_ephem = [
                  "19 Fortuna/Fortuna_ephem.csv", "87 Sylvia/Sylvia_ephem.csv", 
                  "2579 Spartacus/Spartacus_ephem.csv", "58 Concordia/Concordia_ephem.csv", 
                  "111 Ate/Ate_ephem.csv", "353 Ruperto/Ruperto_ephem.csv",
                  "397 Vienna/Vienna_ephem.csv", "477 Italia/Italia_ephem.csv"
                  ]
    i = 1
